...
const cli = (path, options) => {
  if (functionMdLinks.isValidPath(path)) {
    ...
    ${chalk.greenBright('Option 1:')} ${chalk.yellowBright('md-links <path>')}
    ${chalk.greenBright('Option 2:')} ${chalk.yellowBright('md-links <path> --validate || --v')}
    ${chalk.greenBright('Option 3:')} ${chalk.yellowBright('md-links <path> --stast || --s')}
    ${chalk.greenBright('Option 4:')} ${chalk.yellowBright('md-links <path> --stast --validate || --s --v')}
    ${chalk.greenBright('Option 5:')} ${chalk.yellowBright('md-links <path> --validate --stast || --v --s')}
    ${chalk.green('********************************************************************')}
    ...
    console.log(chalk.bgRedBright.black('ERROR:'), chalk.bgYellowBright.black('NO INGRESO RUTA.')
